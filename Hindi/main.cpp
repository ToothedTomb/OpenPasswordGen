...
const char charset[] =
    ...
    "ऽाँॉॐ़ािीुूृेैोौंः्॒॑॓॔ॠॡ0123456789!@#$%^&*()";
...
void on_generate_password(GtkWidget *widget, gpointer data) {
    ...
    try {
        ...
        gtk_entry_set_text(GTK_ENTRY(entry_password), "त्रुटि 1 - अमान्य लंबाई");
    } catch (std::out_of_range&) {
        gtk_entry_set_text(GTK_ENTRY(entry_password), "त्रुटि 2 - लंबाई सीमा से बाहर");
    }
}
...
int main(int argc, char *argv[]) {
    ...
    gtk_window_set_title(GTK_WINDOW(window), "पासवर्ड जनरेटर खोलें!");
    ...
    // Title
    GtkWidget *title = gtk_label_new("<u><b><big> पासवर्ड जनरेटर खोलें: </big></b></u>");
    ...
    GtkWidget *label_length = gtk_label_new("पासवर्ड की लंबाई दर्ज करें:");
    gtk_box_pack_start(GTK_BOX(vbox), label_length, FALSE, FALSE, 5);

    entry_length = gtk_entry_new();
    gtk_entry_set_placeholder_text(GTK_ENTRY(entry_length), "उदाहरण - 12");
    ...
    GtkWidget *generate_button = gtk_button_new_with_label("पासवर्ड जनरेट करें");
    ...
    gtk_entry_set_placeholder_text(GTK_ENTRY(entry_password), "जनरेट किया गया पासवर्ड यहां दिखाई देगा");
    gtk_box_pack_start(GTK_BOX(vbox), entry_password, FALSE, FALSE, 5);
    //With this button you will be able to copy to clipboard...
    GtkWidget *copy_button = gtk_button_new_with_label("क्लिपबोर्ड पर कॉपी करें");
